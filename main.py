...
# It helped me to learn python and github environment with version tracking
# Project started on 19-Nov-2024

exec(open(R"C:\Users\WE FIX IT\Desktop\MiaBudget\converter\transaction_processor.py").read())